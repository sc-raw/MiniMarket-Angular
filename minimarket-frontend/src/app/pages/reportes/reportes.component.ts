    ...
    <div class="container mt-4">
      ...
      @if (cargando()) {
        ...
        @if (auth.puedeVerReportesFinancieros()) {
          <!-- TARJETAS FINANCIERAS (admin, cajero, atencion) -->
          <div class="row mb-4">
        ...
        @if (auth.puedeVerReportesStock()) {
          <!-- TARJETAS DE STOCK (admin, reponedor) -->
          <div class="row mb-4">
            <div class="col-md-3 mb-3">
            ...
            <div class="col-md-3 mb-3">
              <div class="card text-white bg-warning h-100">
                <div class="card-body text-center">
                  ...
                  <h2 class="text-dark">{{ resumen()?.cantidadPorVencer ?? 0 }}</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          @if (auth.puedeVerReportesStock()) {
            ...
            <div class="col-md-6 mb-4">
              <div class="card shadow border-danger">
                ...
                <div class="card-body">
                  <table class="table table-sm">
                    <thead><tr><th>Código</th><th>Nombre</th><th>Vencimiento</th><th class="text-end">Stock</th></tr></thead>
                    <tbody>
                      @for (p of productosVencidos(); track p.idProducto) {
                        <tr>
                          <td>{{ p.codigo }}</td>
                          <td>{{ p.nombre }}</td>
            ...
            <div class="col-md-6 mb-4">
              <div class="card shadow border-warning">
                ...
                <div class="card-body">
                  <table class="table table-sm">
                    <thead><tr><th>Código</th><th>Nombre</th><th>Vence</th><th class="text-end">Stock</th></tr></thead>
                    <tbody>
                      @for (p of productosPorVencer(); track p.idProducto) {
                        <tr>
                          <td>{{ p.codigo }}</td>
                          <td>{{ p.nombre }}</td>
